...
from app.my_project.auth.dao.dao import CountryDAO, CityDAO, WeatherConditionLabelDAO, DailyWeatherDAO, HourlyWeatherDAO, WeatherAlertDAO, WeatherForecastDAO,UserDAO, UserPreferencesDAO,UserHasCityDAO
...
class UserPreferencesService:
    ...
    def delete_user_preference(id_user_preferences):
        UserPreferencesDAO.delete(id_user_preferences)

    
class UserHasCityService:
    @staticmethod
    def get_all_user_city_links():
        return UserHasCityDAO.get_all_user_city_links()
